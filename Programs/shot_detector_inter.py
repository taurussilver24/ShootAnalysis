            ...
            for r in results:
                ...
                for box in boxes:
                    ...
                    if conf > 0.75:
                        ...
                        if (current_class == "Hoop" and conf > 0.3) or \
...
if __name__ == "__main__":
    ...
    ShotDetector(model_path="Yolo-Weights/" + args.model, video_path="HoopVids/Done_Requested/" + args.video, video_name = args.video)
